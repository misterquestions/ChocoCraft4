...
public class ChocoboInventoryScreen extends AbstractContainerScreen<SaddleBagMenu> {
	...
	public ChocoboInventoryScreen(SaddleBagMenu container, Inventory playerInventory, Chocobo chocobo) {
	...
	public static void openInventory(int windowId, Chocobo chocobo) {
		...
		SaddleBagMenu saddleContainer = new SaddleBagMenu(windowId, player.getInventory(), chocobo);
